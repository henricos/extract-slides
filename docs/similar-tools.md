...
**None of the projects below actually crops to the slide region.** Each was checked against its own source while researching this stage (see `docs/research/slide-region-crop.md`): they detect a region, mask it for change detection, or ship a manual tool, but the frame they write to disk is uncropped. Treat this stage as greenfield.
